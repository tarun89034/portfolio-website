          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <div className="flex items-center gap-3">
              <motion.a
                ...
                className="w-12 h-12 glass-card rounded-full flex items-center justify-center text-white/50 hover:text-[#6C8CFF] border border-white/10 hover:border-[#6C8CFF]/40 transition-all"
              >
              ...
              <motion.a
                ...
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                className="w-12 h-12 glass-card rounded-full flex items-center justify-center text-white/50 hover:text-white border border-white/10 hover:border-white/30 transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
